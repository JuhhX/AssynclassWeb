            ...
            <nav className='flex flex-col pr-2 overflow-auto scrollbar-thin scrollbar-thumb-verde'>
                {
                    ...
                    <>
                        ...
                        <a href="/teacher/charts" className='text-azulsel font-semibold text-xl flex flex-row gap-6 p-2 px-4 transition-colors rounded-l-lg hover:bg-verde'><BarChart color='#5B61CE' size={34} /> Gráficos</a>
                    ...
                    <>
                        ...
                        <a href="/instituition/charts" className='text-azulsel font-semibold text-xl flex flex-row gap-6 p-2 px-4 transition-colors rounded-l-lg hover:bg-verde'><BarChart color='#5B61CE' size={34} /> Gráficos</a>
                        <a href="/instituition/search_students" className='text-azulsel font-semibold text-xl flex flex-row gap-6 p-2 px-4 transition-colors rounded-l-lg hover:bg-verde'><GraduationCap color='#5B61CE' size={34} /> Alunos</a>
                        <a href="/instituition/search_teachers" className='text-azulsel font-semibold text-xl flex flex-row gap-6 p-2 px-4 transition-colors rounded-l-lg hover:bg-verde'><Users2 color='#5B61CE' size={34} /> Professores</a>
                        <a href="/coupons" className='text-azulsel font-semibold text-xl flex flex-row gap-6 p-2 px-4 transition-colors rounded-l-lg hover:bg-verde'><CircleDollarSign color='#5B61CE' size={34} /> Cupons</a>
