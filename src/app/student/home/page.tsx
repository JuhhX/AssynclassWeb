...

      {
        ...
        :
          <>
            {
              (contents.length == 0) ?
                <h1 className="text-azul text-xl dark:text-azulsel">{"SEM ATIVIDADES ATRIBUIDAS NO MOMENTO 😃"}</h1>
              :
                contents.map((c) => {
                  return (
                    <div key={c.contentID} className="w-full border-2 border-b-4 border-azul p-4 rounded-xl flex flex-col dark:shadow-neon-azul">
