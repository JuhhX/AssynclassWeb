...
export default function StudentSearchTeacher() {
    ...
    return (
        <main className="h-screen overflow-auto w-full flex flex-col p-8 px-16 gap-8 overflow-hidden">
            <h1 className={`text-azul text-3xl font-semibold`}>Professores e mentores</h1>

            <div className="w-full h-full flex flex-row">
                <div className="h-1/4 w-1/5 border-2 border-b-4 border-azul rounded-xl p-4 justify-center flex flex-col items-center">
