...
export default function Login() {
    ...
    return (
      <main className="h-screen w-full flex flex-row justify-center box-border overflow-auto">
        ...
        <button className={`absolute right-8 top-8 pointer text-azul font-bold text-3xl`}>X</button>
        <a href="/register/teacher" className={`pointer absolute right-8 bottom-8 pointer text-verde border-2 border-b-4 rounded-xl p-2 border-verde font-bold text-xl`}>CRIAR CONTA</a>
